---
title: Sponsors
description: The humans and organizations keeping OculiX going.
---
...
If you or your company use OculiX in production and would like to help cover the maintenance cost, you can sponsor the project via [GitHub Sponsors](https://github.com/sponsors/julienmerconsulting). Any amount, recurring or one-off, helps.
...
Time is worth more than money. A PR that fixes a real bug, a docs page that prevents fifty support questions, an RC test on Apple Silicon — all of those are worth more than a one-line "thanks for the project" donation. See [Contributing](/community/contributing/).
...
- A LinkedIn post tagging [@julienmerconsulting](https://www.linkedin.com/in/julienmer/)
...
A heartfelt thank you to everyone supporting the project. The list of named sponsors is on the [GitHub Sponsors page](https://github.com/sponsors/julienmerconsulting) — and there are many more who help anonymously, in code, in bug reports, in RC tests, in translations.
